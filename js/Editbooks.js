$(document).ready(function () {
  ...
  $("#upload").on("change", function () {
    if (this.files && this.files[0]) {
      ...
      imag.src = URL.createObjectURL(this.files[0]);
      $('#eik').attr('src', imag.src);
      imag2 = this.files[0];
      console.log(imag2);
  ...
  $("body").on("click", "#submIT", function () {
    ...
    console.log(finalImage);
    // var imag2 = $("#upload").files[0];
    // imag = "Books_Images/" + imag.toString().slice(12);
    // var imgInput = $("#upload");
    // var imag = document.querySelector("#eik");
    // var srcImg = URL.createObjectURL(imgInput.files[0]);
